...
def render_topbar_with_logo(dias_restantes):
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .top-container-left, .top-container-right, .titles-container {{
                width: 100%;
                text-align: center;
                align-items: center;
                margin-left: 0;
            ...
            .titles-container {{
                order: 1; /* Coloca os títulos no topo no layout mobile */
            }}
            .top-container-left {{
                order: 2; /* Move a logo para baixo dos títulos */
                justify-content: center;
            }}
            .top-container-right {{
                order: 3; /* Move o tempo para baixo da logo */
                align-items: center;
            }}
        }}
    </style>
    <div class="top-container">
        <div class="top-container-left">
            <img src="https://files.cercomp.ufg.br/weby/up/1/o/UFG_colorido.png" alt="Logo UFG" class="logo-ufg"/>
        ...
        * {
        ...
        .top-container {
            ...
            grid-template-areas:
                ...
                ". main-title right-corner-bottom";
