...
def create_altair_stacked_bar(df_summary):
    ...
    ).properties(height=450, title=alt.TitleParams(text="Percentual de Conclusão por Disciplina", anchor='middle', fontSize=18))
...
def create_questoes_bar_chart(ed_data):
    ...
    return (chart + text).properties(height=450, title=alt.TitleParams("Distribuição de Questões", anchor='middle', fontSize=18))
